...
%%% Load data
% WITH NOISE
AC10N200 = load('IAT_P200_D20_C100000_N200.csv');
AC10N200 = AC10N200(1:max_entries);
AC5N200 = load('IAT_P200_D20_C50000_N200.csv');
AC5N200 = AC5N200(1:max_entries);
AC1N200 = load('IAT_P200_D20_C10000_N200.csv');
AC1N200 = AC1N200(1:max_entries);

% WITHOUT NOISE
AC10N0 = load('IAT_P200_D20_C100000_N0.csv');
AC10N0 = AC10N0(1:max_entries);
AC5N0 = load('IAT_P200_D20_C50000_N0.csv');
AC5N0 = AC5N0(1:max_entries);
AC1N0 = load('IAT_P200_D20_C10000_N0.csv');
...
%%% Load data
% WITH NOISE
BC10N20 = load('IAT_P20_D10_C100000_N20.csv');
BC10N20 = BC10N20(1:max_entries);
BC5N20 = load('IAT_P20_D10_C50000_N20.csv');
BC5N20 = BC5N20(1:max_entries);
BC1N20 = load('IAT_P20_D10_C10000_N20.csv');
BC1N20 = BC1N20(1:max_entries);

% WITHOUT NOISE
BC10N0 = load('IAT_P20_D10_C100000_N0.csv');
BC10N0 = BC10N0(1:max_entries);
BC5N0 = load('IAT_P20_D10_C50000_N0.csv');
BC5N0 = BC5N0(1:max_entries);
BC1N0 = load('IAT_P20_D10_C10000_N0.csv');
...
%%% Load data
CC5N10 = load('IAT_P100_D10_C50000_N10.csv');
CC5N10 = CC5N10(1:max_entries);
CC5N0 = load('IAT_P100_D10_C50000_N0.csv');
CC5N0 = CC5N0(1:max_entries);
CC5N100 = load('IAT_P100_D10_C50000_N100.csv');
