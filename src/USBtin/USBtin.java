...
/**
 * Represents an USBtin.USBtin device.
 * Provide access to an USBtin.USBtin device (http://www.fischl.de/usbtin) over virtual
 * serial port (CDC).
 */
public class USBtin implements SerialPortEventListener {

    /** Serial port (virtual) to which USBtin.USBtin is connected */
    protected SerialPort serialPort;

    /** Characters coming from USBtin.USBtin are collected in this StringBuilder */
    ...
    /** USBtin.USBtin firmware version */
    protected String firmwareVersion;

    /** USBtin.USBtin hardware version */
    protected String hardwareVersion;

    /** USBtin.USBtin serial number */
    protected String serialNumber;

    /** Timeout for response from USBtin.USBtin */
     ...
     * During connect() the firmware version is requested from USBtin.USBtin.
     *
     ...
     * During connect() the hardware version is requested from USBtin.USBtin.
     *
     ...
     * During connect() the serial number is requested from USBtin.USBtin.
     *
    ...
    /**
     * Connect to USBtin.USBtin on given port.
     ...
     * @throws USBtinException Error while connecting to USBtin.USBtin
     */
    ...
    /**
     * Read response from USBtin.USBtin
     *
     * @return Response from USBtin.USBtin
     * @throws SerialPortException Error while accessing USBtin.USBtin
    ...
    /**
     * Transmit given command to USBtin.USBtin
     *
     * @param cmd Command
     * @return Response from USBtin.USBtin
     ...
     *
     * @param fc Filter chains (USBtin.USBtin supports maximum 2 hardware filter chains)
     * @throws USBtinException On serial port errors
     */
